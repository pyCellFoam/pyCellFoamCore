...
#==============================================================================
    ...
    def __setShowNormalVec(self,s): 
        if self.myReverse:
            ...
            self.logger.error('Cannot set showNormalVec because the reversed edge does not belong to an edge')
    ...
    def __setShowBarycenter(self,s): 
        if self.myReverse:
            ...
            self.logger.error('Cannot set showBarycenter because the reversed edge does not belong to an edge')
...
#-------------------------------------------------------------------------           
    def addVolume(self,volume):
        if self.myReverse:
            ...
            self.logger.error('Cannot add volume {} to reversed face {} because it does not belong to a face'.format(volume.infoText,self.infoText))
#-------------------------------------------------------------------------
...
#-------------------------------------------------------------------------               
    def delVolume(self,volume):
        if self.myReverse:
            ...
            self.logger.error('Cannot delete volume {} from reversed face {} because it does not belong to a face'.format(volume.infoText,self.infoText))
