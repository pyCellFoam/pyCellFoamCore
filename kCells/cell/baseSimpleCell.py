...
#==============================================================================
    ...
    def __setTikZLabelPosition(self,t): 
        if t in ['left','right','above','below','below right','below left','above right','above left']:
            self.__tikZLabelPosition = t
        else:
            self.logger.error('Unknown position for TikZ label {}'.format(t))
    tikZLabelPosition = property(__getTikZLabelPosition,__setTikZLabelPosition)
    ...
    def __getIsGeometrical(self):
        if self.belongsTo:
            ...
            self.logger.warning('Simple cell {} does not belong to a real cell, using fixed standard value for isGeometrical'.format(self.infoText))
            return False
    ...
    def __getColor(self):
        if self.belongsTo:
            ...
            self.logger.warning('Simple cell {} does not belong to a real cell, using fixed standard value for color'.format(self.infoText))
            return tc.TUMOrange()
    ...
    def __getNum(self):
        if self.belongsTo:
            ...
            self.logger.warning('Simple cell does not belong to a real cell, using fixed standard value for num')
            return super().num
    ...
    def __getIsDual(self):
        if self.belongsTo:
            ...
            self.logger.warning('Simple cell does not belong to a real cell, using fixed standard value for isDual')
            return super().isDual
    ...
    def __getCategoryText(self):
        if self.belongsTo:
            ...
            self.logger.warning('Simple cell does not belong to a real cell, using fixed standard value for categoryText')
    ...
    def __getShowLabel(self):
        if self.belongsTo:
            ...
            self.logger.warning('Simple cell {} does not belong to a real cell, using fixed standard value for showLabel'.format(self.infoText))
            return True
    ...
    def __getGrayInTikz(self):
        if self.belongsTo:
            ...
            self.logger.warning('Simple cell {} does not belong to a real cell, using fixed standard value for grayInTikz'.format(self.infoText))
            return False
