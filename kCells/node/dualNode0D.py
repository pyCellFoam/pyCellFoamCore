...
#    INITIALIZATION
#==============================================================================
    def __init__(self,node,*args,myPrintDebug=None,myPrintError=None,edge=None,face=None,volume=None,**kwargs):
        '''
        ...
        myPrintDebug('volume: {}, face: {}, edge: {}'.format(volume,face,edge))
