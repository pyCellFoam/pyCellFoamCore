...
#-------------------------------------------------------------------------        
    ...
    def plotNodeTikZ(self,tikZPic,showLabel=None,draw=None,fill=None,color=None,showInPlot=None,dim=3,**kwargs):
        '''
        ...
        if draw:
            ...
            nodeOptions.append('minimum size=2mm')
...
#-------------------------------------------------------------------------
    ...
    def addEdge(self,edge):
        ...
        :param Edge edge: An edge or reversed edge where this node will be part of
