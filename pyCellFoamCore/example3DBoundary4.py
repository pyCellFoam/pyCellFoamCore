...
#     # Create faces by defining the border edges
    ...
    f36 = Face([e54,e56,-e55])
    f37 = Face([e0,e55,-e36])
    f38 = Face([e18,e56,-e36])
    f39 = Face([e0,e54,-e18])
...
#==============================================================================
    ...
    v0 = Volume([-f0,f4,f12,-f14,f24,-f25,-f36])
    ...
    for f in v0.faces:
        for e in f.edges:
            edges_temp.append(e)
    cc.printMagenta("edges_temp1 original:", edges_temp)
...
#==============================================================================
    ...
    for f in v0.faces:
        for e in f.edges:
            edges_temp2.append(e)
    cc.printMagenta("edges_temp2:", edges_temp2)
