                            ...
                            for se in f.simpleEdges:
                                ...
                                # If the current edge is in the found edges and not the reversed one, then the reversed face should be added
                                    ...
                                    # Detect possible errors
                                        ...
                                        _log.error('One edge is not allowed to be more than twice (normal and reversed) in the same volume {}'.format(self.infoText))
                                    
                    if not found:
                        _log.error('Cannot add one of the faces {} to volume {}'.format(unalignedFaces,self.infoText))
                        count = maxCount
