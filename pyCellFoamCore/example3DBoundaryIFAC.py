...
n153 = Node(9.0, 0.0, -5.0, num=153)
n155 = Node(9.0, 0.0, 9.0, num=155)
n157 = Node(-5.0, 0.0, -5.0, num=157)
n159 = Node(-5.0, 0.0, 9.0, num=159)
n168 = Node(9.0, 9.0, -5.0, num=168)
n169 = Node(9.0, 9.0, 9.0, num=169)
n172 = Node(-5.0, 9.0, -5.0, num=172)
n173 = Node(-5.0, 9.0, 9.0, num=173)
n147 = Node(0.0, -5.0, -5.0, num=147)
n151 = Node(0.0, -5.0, 9.0, num=151)
n165 = Node(9.0, -5.0, 0.0, num=165)
n167 = Node(-5.0, -5.0, 0.0, num=167)
n170 = Node(9.0, -5.0, -5.0, num=170)
n171 = Node(9.0, -5.0, 9.0, num=171)
n174 = Node(-5.0, -5.0, -5.0, num=174)
n175 = Node(-5.0, -5.0, 9.0, num=175)
...
n1000 = Node(0.0, 0.0, 9.0, num=1000)
n1001 = Node(9.0, 0.0, 0.0, num=1001)
...
e17.color = tc.TUMRose()
e28.color = tc.TUMRose()
...
match PLOTTING_METHOD:
    ...
    case "TikZ":
        ...
        perspective = TikZPerspective(
            "persp_pre_processing_edges",
            np.array([-0.9, 0.3]),
            np.array([0.8, 0.4]),
            np.array([0, 1]),
        )
        pic = TikZPicture3D(tikZPerspective=perspective)
        pic.scale = 0.3

        for n in nodes:
            n.plotNodeTikZ(pic, showLabel=False)
        for e in edges:
            e.plotEdgeTikZ(pic, showLabel=False, showArrow=False)
        # for f in faces:
        #     f.plotFaceTikZ(pic, showLabel=True, showNormalVec=False, showBarycenter=False)

        pic.writeLaTeXFile('latex', "pre_processing_edges", compileFile=True, openFile=True)
        # pic.writeTikZFile("latex", 'pre_processing_edges')
